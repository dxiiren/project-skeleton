...
Write-Host "  1) Serve the site:  just start   (foreground: just serve)" -ForegroundColor Gray
Write-Host "  2) Open it:         just open    (http://127.0.0.1:@@PORT@@)" -ForegroundColor Gray
